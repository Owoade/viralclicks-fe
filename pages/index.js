    ...
    return (
        <div className="index-parent-container">
            <div className="hero-container">
                ...
                <svg width="100%" height="50%" id="svg" viewBox="0 0 1440 400" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150" style={{pointerEvents:none}}>
